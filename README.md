...
5. Select the page options you want (e.g. Sidebar) and tap the **View as Standalone Page** button to view your Markdown file as a web page for sharing or embedding
